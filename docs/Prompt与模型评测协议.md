...
| C3 | 六味地黄胶囊 / 0.3g×60粒/盒；month=2026-03；theme=专题分析；focus=制费 | P3 专题仍含全部三要素用于勾稽；核对设备事件与当月 CSV 趋势，不能把维修记录直接归因为上涨；主跑 P2 同月同规格跨厂三步法，二厂缺明细须披露 | P3 专题 Word/PDF；P2 独立结果；人工评分；一条由所选分析建议转出的任务 |
